                        ...
                        <div class="en_bref">
                            <form action="../Controller/ajout_rendez_vous_bdd.php" method="post">
                                ...
                                <select name="Id_Patient" class="form-control">
                                    ...
                                    $query = "SELECT Nom_Patient FROM patient";
                                    ...
                                    $patients = mysqli_fetch_all($result, MYSQLI_BOTH);
                                    foreach ($patients as $patient) {
                                        echo '<option value="' . $patient['Id_Patient'] . '">' . $patient['Id_Patient']. $patient['Nom_Patient'] . ' ' . $patient['Prenom_Patient'] . '</option>';
                                    }
                                    ?>
                                </select>
