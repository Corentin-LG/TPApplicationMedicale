            ...
            <div id="content" class="span9">
                <div class="main_body">
                    ...
                    <div class="Left-body">
                        ...
                        <div class="en_bref">
                        <form action="../Controller/chercher_un_patient_bdd.php" method="post">
                                <input type="text" name="nom_patient" placeholder="Nom du patient" />
                                <input type="submit" value="Rechercher" />
                        </form>


                            <form class="en_bref_2" action="../Controller/affichage_patient_bdd.php" method="get">
